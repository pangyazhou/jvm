...
import (
	...
	"main/instructions/comparisons"
	"main/instructions/constants"
	"main/instructions/control"
	"main/instructions/conversions"
	"main/instructions/extended"
	"main/instructions/loads"
	"main/instructions/math"
	"main/instructions/references"
	"main/instructions/stack"
	"main/instructions/stores"
)
...
var (
	...
	iastore  = &loads.IASTORE{}
	lastore  = &loads.LASTORE{}
	fastore  = &loads.FASTORE{}
	dastore  = &loads.DASTORE{}
	aastore  = &loads.AASTORE{}
	bastore  = &loads.BASTORE{}
	castore  = &loads.CASTORE{}
	sastore  = &loads.SASTORE{}
